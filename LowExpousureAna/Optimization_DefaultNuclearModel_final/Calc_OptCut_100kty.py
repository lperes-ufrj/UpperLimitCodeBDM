#!/usr/bin/env python3
"""
Calc_OptCut_100kty.py

Low-exposure version for 100 kt-year. The main repository workflow uses
400 kt-year via 40 kton x 10 years. Here the atmospheric background
normalization is scaled to 100 kt-year = 10 x 10 kt-year.
...
def main() -> None:
    ...
    background_scale = exposure_10kty_units * 2495.98 / float(n_sim_atm)
