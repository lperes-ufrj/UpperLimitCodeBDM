#!/usr/bin/env python3
"""
ApplyNominalCuts_ToOtherNuclearModels_100kty.py

Low-exposure version for 100 kt-year. The nominal cuts are applied exactly
as in the 400 kt-year workflow, but the atmospheric background normalization
is scaled to 100 kt-year = 10 x 10 kt-year.
...
Output:
  ...
  --nominal-eff-bkg ../Optimization_DefaultNuclearModel_final/generated/20260512_211502/Eff_Bkg_index_00a.txt \
  --seed 12345
...
def main() -> None:
    ...
    for model_name, model_code in DEFAULT_NUCLEAR_MODELS:
        ...
        # Match the low-exposure Calc_OptCut_100kty.py normalization. The selected atmospheric
        ...
        exposure_10kty_units = 10.0  # 100 kt-year / 10 kt-year
        background_scale = exposure_10kty_units * EXPECTED_BKG_10KTY / float(n_sim_atm)
        ...
        f_info.write("Exposure: 100 kt-year\n")
        f_info.write(f"Atmospheric background scale: {background_scale}\n\n")
