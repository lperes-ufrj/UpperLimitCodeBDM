...
dataloader.PrepareTrainingAndTestTree(
    ...
    ":".join([
        ...
        "SplitMode=Random",
        "NormMode=EqualNumEvents",  # Ensures balanced training
        "!V"
    ])
)
...
method = factory.BookMethod(
    ...
    ":".join([
        ...
        "MaxDepth=6",          # Allow deeper trees
        "BoostType=AdaBoost",  # Boosting type
        "AdaBoostBeta=0.2",    # AdaBoost Beta
...
method.SaveAs("trained_BDTAtmCCNC_"+{timestamp}+".xml")
